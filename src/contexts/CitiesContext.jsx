...
function reducer(state, action) {
  switch (action.type) {
    ...
    default:
      throw new Error("dispatch function not recognized");
  }
}
...
function CitiesProvider({ children }) {
  ...
  async function postCity(newCity) {
    ...
    try {
      ...
      dispatch({
        type: "rejected",
        payload: "something went wrong with creating new city",
      });
    }
  }
  ...
  async function deleteCity(id) {
    ...
    try {
      ...
      dispatch({
        type: "rejected",
        payload: "something went wrong with with deleting city",
      });
    }
  }
